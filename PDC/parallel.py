    ...
    def print(self):
        ...
        for vehicle_id in xrange(self.data.num_vehicles):
            ...
            while not self.routing.IsEnd(index):
               ...
               plan_output += ' {0} Load({1}) Time({2},{3}) Slack({4},{5}) ->'.format(node_index,route_load,time_min, time_max,slack_min, slack_max)
...
#      demand_evaluator = CreateDemandEvaluator(data)
#      demand_evaluator.add_capacity_constraints(routing, data, demand_evaluator)
#      # Add Time Window constraint
#      time_evaluator = CreateTimeEvaluator(data)
#      time_evaluator.add_time_window_constraints(routing, data, time_evaluator)
